    ...
    <body>
        ...
        <div id="header" class="mdl-shadow--2dp">
            ...
            <div id="nav">
                ...
                <a href="#contribute"><div class="nav-elem scroll" id="nav-contribute"><?php t("contribute") ?></div></a>
                <a href="#about"><div class="nav-elem scroll" id="nav-about"><?php t("about") ?></div></a>
                ...
                <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" id="nav-language-picker-menu" for="nav-language-picker">
                    ...
                    <?php }} ?>
                    <li class="mdl-menu__item scroll" id="nav-language-picker-add">Add language...</li>
                </ul>
            </div>
        </div>
        <div id="content">
